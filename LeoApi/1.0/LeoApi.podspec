...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lilizing/LeoApi"
  ...
  s.source       = { :git => "https://github.com/lilizing/LeoApi.git", :tag => s.version.to_s }
  ...
  s.source_files  = "LeoApi/LeoApi/**/*.{h,m,swift}"
